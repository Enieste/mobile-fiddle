...
const Icon = responsiveWidthHeight(({ width, height }) =>
  <Svg width={width} height={height} viewBox="0 0 183 184">
    <G fill="none" fillRule="evenodd" transform="scale(0.4) translate(135, 110)">
      <Circle
        cx="92"
        cy="92"
        r="92"
        fill={iconFont}
      />
      <G fill="#FFFFFF" fillRule="nonzero" transform="scale(0.5) translate(92, 92)">
...
export default class BlueUploadIcon extends React.PureComponent {
  render() {
    return (<Icon />);
  }
};